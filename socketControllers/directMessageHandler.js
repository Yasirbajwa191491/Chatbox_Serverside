...
const directMessageHandler = async (socket, data) => {
    try {
        ...
        if (conversation) {
            ...
            sendNewDirectMessage(conversation._id.toString(), newMessage,senderUserId,receiverUserId);
        } else {
            ...
            // update the chat of the participants with newly sent message
            sendNewDirectMessage(newConversation._id.toString(), newMessage,senderUserId,receiverUserId);
        }
    } catch (err) {
        console.log(err);
    }
